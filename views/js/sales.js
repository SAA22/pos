      	...
      	success:function(answer){
	          ...
	          '<div class="col-xs-6" style="padding-right:0px">'+
	            ...
	            '<div class="input-group">'+
	              ...
	              '<span class="input-group-addon"><button type="button" class="btn   removeProduct" style="padding-top:-4px" idProduct="'+idProduct+'"><i class="glyphicon glyphicon-trash"></i></button></span>'+
	          ...
	          '<div class="col-xs-3 enterPrice" style="padding-left:0px">'+
	            ...
	            '<div class="input-group">'+
	              ...
	              '<span class="input-group-addon">&#108;&#101;&#105;</i></span>'+
...
$(".saleForm").on("change", "input.newProductQuantity", function(){
	...
	if(Number($(this).val()) > Number($(this).attr("stock"))){
		...
		swal({
	      title: "Cantitatea este mai mare decât stocul",
	      text: "Sunt doar"+$(this).attr("stoc")+" unități!",
	      type: "error",
		...
		$(this).parent().parent().parent().children(".paymentMethodBoxes").html(
			 ...
			 '<div class="col-xs-4">'+ 
			 	...
			 	'<div class="input-group">'+ 
			 		...
			 		'<input type="text" class="form-control" id="newCashValue" placeholder="sumă primită" required>'+
			 ...
			 '<div class="col-xs-4" id="getCashChange" style="padding-left:0px">'+
			 	...
			 	'<div class="input-group">'+
			 		...
			 		'<input type="text" class="form-control" id="newCashChange" placeholder="rest datorat" readonly required>'+
...
$(".tables").on("click", ".btnDeleteSale", function(){
  ...
  swal({
        title: 'Ești sigur că vrei șa stergi vânzarea?',
        ...
        confirmButtonText: 'Da, șterge vânzarea!'
      }).then(function(result){
        if (result.value) {
          
            window.location = "index.php?route=sells&idSale="+idSale;
        }
...
$('#daterange-btn').daterangepicker(
  ...
  function (start, end) {
    ...
    var captureRange = $("#daterange-btn span").html();
   	...
   	window.location = "index.php?route=sells&initialDate="+initialDate+"&finalDate="+finalDate;
