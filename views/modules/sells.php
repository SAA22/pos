...
if($xml){
  ...
  echo '<a class="btn btn-block btn-success openXML" file="xml/'.$_GET["xml"].'.xml" href="sells">Fișierul XML a fost creat cu succes<span class="fa fa-times pull-right"></span></a>';
    ...
    <div class="box">
      ...
      <div class="box-header with-border">
        ...
        <button type="button" class="btn btn-default pull-right" id="daterange-btn">
            ...
            <span>
              <i class="fa fa-calendar"></i> &#206;nterval v&#226;nz&#259;ri
        ...
        <table class="table table-bordered table-striped dt-responsive tables" width="100%">
          ...
          foreach ($answer as $key => $value) {
           ...
           echo '<td>'.($key+1).'</td>
                  ...
                  <td>'.number_format($value["netPrice"],2).' RON</td>

                  <td>'.number_format($value["totalPrice"],2).' RON</td>
                  ...
                  <td>
                    ...
                    <div class="btn-group">
                     ...
                     <a href="index.php?route=sells&xml='.$value["code"].'" class="btn btn-success btnXml">  <i class="fa fa-file-excel-o"></i></a>
