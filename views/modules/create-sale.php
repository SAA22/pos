...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Creaz&#259; vanzare</li>
    ...
    <div class="row">
      ...
      <div class="col-lg-5 col-xs-12">
        ...
        <div class="box box-success">
          ...
          <div class="box-header with-border">List&#259; Cumpar&#259;turi</div>
          ...
          <form role="form" method="post" class="saleForm">
            ...
            <div class="box-body">
                ...
                <div class="box">
                    ...
                    <button type="button" class="btn btn-default hidden-lg btnAddProduct">Adaug&#259; Produs</button>
                            ...
                            <tr>
                              ...
                              <td style="width: 50%">
                                ...
                                <div class="input-group">
                                  ...
                                  <input type="number" class="form-control" name="newSaleTotal" id="newSaleTotal" placeholder="sumă datorată" totalSale="" readonly required>
            ...
            <div class="box-footer">
              <button type="submit" class="btn btn-primary pull-right">Salveaz&#259; vanzare</button>
            </div>
          </form>
              ...
              <table class="table table-bordered table-striped dt-responsive salesTable">
                ...
                <thead>
                   ...
                   <tr>
                     ...
                     <th>Imagine</th>
                     <th style="width:100px">Cod de bare</th>
                     <th>Descriere</th>
                     <th>Stoc</th>
                     <th>Ac&#355;iune</th>
    ...
    <div class="modal-content">
      <form role="form" method="POST">
        ...
        <div class="modal-body"> 
          <div class="box-body">
            ...
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-user"></i></span>
                <input class="form-control input-lg" type="text" name="newCustomer" placeholder="Nume" required>
              </div>
            </div>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary">Salveaza Client</button>
        </div>
      </form>
