...
class ControllerSales{
   ...
   //  //$printer = new Printer($connector);
			...
			// 	//$imprimanta = "58mm";$connector = new WindowsPrintConnector("smb://sell-smart.ro/58mm");

			// 	$connector = new WindowsPrintConnector("smbclient://sell-smart.ro/58mm");

			// 	$printer = new Printer($connector);

			// 	$printer  -> text("Listeaza");	
			...
			// 	swal({
			// 		  type: "success",
			// 		  title: "Vânzarea a fost adăugată cu success",
	...
	static public function ctrEditSale(){
		...
		if(isset($_POST["editSale"])){
			...
			if($answer == "ok"){
				...
				swal({
					  type: "success",
					  title: "Vânzarea a fost modificată cu success",
					  showConfirmButton: true,
					  confirmButtonText: "Închide"
					  }).then((result) => {
								if (result.value) {
	...
	static public function ctrDeleteSale(){
		...
		if(isset($_GET["idSale"])){
			...
			if($answer == "ok"){
				...
				swal({
					  type: "success",
					  title: "Vânzarea a fost ștearsă cu success",
					  showConfirmButton: true,
					  confirmButtonText: "Închide",
